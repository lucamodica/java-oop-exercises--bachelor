...
class List_method_k{
  ...
  public static int prop()
   {int i=r();
    if (i % 2 != 0) return i; else return prop();}
    
  public static int noProp()
   {int i=r();
    if ((i % 2 != 0) == false) return i; else return noProp();}
 ...
 public static void check(List l, List ris, int prop, int noProp){
  ...
  if (countElem(ris_string)!=len) 
   ...
   System.out.println("ERRORE  : il primo elemento di risultato deve essere dispari");
